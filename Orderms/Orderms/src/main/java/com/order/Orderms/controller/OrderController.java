...
public class OrderController {
	...
	public String getHello(@ModelAttribute("order") Order ord,Model model) { 
    	...
    	String [] arrDesc= ord.getOrderDesc().split(",");
    	ord.setOrderDesc(Arrays.toString(arrDesc));
    	
    	String [] arrQuatn=ord.getQuantity().split(",");
    	ord.setQuantity(Arrays.toString(arrQuatn));
    	
    	Order finalOrder = new Order(ord.getOrderDesc(),ord.getQuantity(),ord.getTransToken());
